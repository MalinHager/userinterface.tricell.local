const config = require('../configs/globals.json');
...
htmloutput += "<a href=\""+config.webaddress+"http://localhost:3000/api/newvirus\" style=\"color:#336699;text-decoration:none;\">Add New Research Object</a>";
...
htmloutput +=
"<td style=\"text-align:center;\"><a href=\""+config.webaddress+"http://localhost:3000/api/editvirus/"+id+"\" style=\"color:#000000;\"><i class=\"fa-solid fa-pen\"></i></a></td>"+
"<td><a href=\""+config.webaddress+"http://localhost:3000/api/deletevirus/"+id+"\" style=\"color:#336699;\">D</a></td>";
        ...
        if (result.length === 0) {
            ...
            if (req.session.securityAccessLevel === 'A' || req.session.securityAccessLevel === 'B') {
                ...
                <div style="display:flex; align-items:center; justify-content:space-between; width:650px;">
                    <a href=""+config.webaddress+"http://localhost:3000/api/editvirus/${v.ID}" style="color:#336699;text-decoration:none;">
            ...
            else
            {
                ...
                <div style="border:1px solid #333;padding:15px;width:600px;background:#f5f5f5;">
                    ...
                    <div style="display:flex; align-items:center; justify-content:space-between; width:650px;">
                        ...
                        <a href=""+config.webaddress+"http://localhost:3000/api/virus/backup/${v.ID}" style="color:#336699;text-decoration:none;">
