...
htmloutput +="<a href=\""+config.webaddress+"http://localhost:3000/api/newemployee\" style=\"color:#336699;text-decoration:none;\">Add new employee</a>";
...
htmloutput += '' +
		...
		try {
         ...
         "<tr>"+
            ...
            "<td class=\"infodark\" width=\"210\"> &nbsp;<a href=\""+config.webaddress+"http://localhost:3000/api/personnelregistry/"+str_employeecode+"\">"+str_name+"</a></td>"+
            ...
            "<td class=\"infolight\" width=\"112\">"+str_securitylevel+"</td>";
              ...
              if(req.session.loggedin)
                ...
                {
            htmloutput += "<td style=\"text-align:center;\"><a href=\""+config.webaddress+"http://localhost:3000/api/editemployee/"+id+"\" style=\"color:#000000;\"><i class=\"fa-solid fa-pen\"></i></a></td>\n"+
            "<td><a href=\""+config.webaddress+"http://localhost:3000/api/deleteemployee/"+id+"\" style=\"color:#336699;\">D</a></td></td>";
}
  htmloutput += "</tr>";
			}
		} catch (err) {
